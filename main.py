...
def generate_nfts() -> None:
    ...
    folders = [
        ...
        './trait-layers/circles/',
        './trait-layers/squares/',
        './images/',
    ]
    ...
    print('wrote metadata to %s' % Path(METADATA_FILE_NAME).absolute())

    #### Generate Images    
    for item in all_images:
        fname1 = Path(f'./trait-layers/backgrounds/{background_files[item["Background"]]}.jpg').absolute()
